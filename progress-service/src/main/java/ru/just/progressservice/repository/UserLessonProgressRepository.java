...
public interface UserLessonProgressRepository extends JpaRepository<UserLessonProgress, Long> {
    ...
    @Query("SELECT lp FROM UserLessonProgress lp WHERE lp.themeProgress.moduleProgress.courseProgress.id = :courseProgressId AND lp.completed = false ORDER BY lp.themeProgress.moduleProgress.ordinalNumber, lp.themeProgress.ordinalNumber, lp.ordinalNumber ASC LIMIT 1")
    ...
    List<UserLessonProgress> findByThemeProgressId(Long themeProgressId);
}
