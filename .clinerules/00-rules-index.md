...
Этот каталог содержит проектные правила работы AI-агента.

## Файлы правил
- [10-memory-bank-workflow.md](./10-memory-bank-workflow.md)
- [20-task-flow-and-modes.md](./20-task-flow-and-modes.md)
...
2. Для выполнения задачи применять правила из остальных файлов по релевантности.
